...
export default function GraphComponent() {
    ...
    const SE = data.filter((item) => item.departmentName === 'Software Engineering' || item.departmentOwner === 'Software Engineering').length;
    ...
    const Operations = data.filter((item) => item.departmentName === 'Operations').length;
                ...
                series={[
                    {
                        data: [
                            ...
                            { id: 1, value: PM, label: 'Project  Management' },
                            { id: 2, value: DE, label: 'Designing' },
                            { id: 6, value: Sales, label: 'Sales' },
                            { id: 4, value: Operations, label: 'Operations' },
                            { id: 5, value: hr, label: 'HR'},
                            { id: 3, value: DevOps, label: 'DevOps' },
